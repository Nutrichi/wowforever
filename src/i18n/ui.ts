...
export const ui = {
  en: {
    ...
    'clips.metaTitle': 'WoW Forever clips: the most watched of the day',
    ...
    'streams.metaTitle': 'WoW Forever streams, live on Twitch right now',
    'streams.description': 'Live WoW Forever and WoW Classic streams on Twitch, refreshed several times a day.',
  ...
  nl: {
    ...
    'clips.metaTitle': 'WoW Forever clips: de meest bekeken van de dag',
    ...
    'streams.title': 'Streams',
    'streams.metaTitle': 'WoW Forever streams, nu live op Twitch',
    'streams.description': 'Live WoW Forever- en WoW Classic-streams op Twitch, een paar keer per dag ververst.',
  ...
  fr: {
    ...
    'clips.metaTitle': 'Clips WoW Forever : les plus vus du jour',
    ...
    'streams.title': 'Streams',
    'streams.metaTitle': 'Streams WoW Forever, en direct sur Twitch',
    'streams.description': 'Streams WoW Forever et WoW Classic en direct sur Twitch, actualisés plusieurs fois par jour.',
  ...
  es: {
    ...
    'clips.metaTitle': 'Clips de WoW Forever: los más vistos del día',
    ...
    'streams.title': 'Streams',
    'streams.metaTitle': 'Streams de WoW Forever, en directo en Twitch',
    'streams.description': 'Streams de WoW Forever y WoW Classic en directo en Twitch, actualizados varias veces al día.',
  ...
  it: {
    ...
    'clips.metaTitle': 'Clip di WoW Forever: i più visti del giorno',
    ...
    'streams.metaTitle': 'Stream di WoW Forever, in diretta su Twitch',
    'streams.description': 'Stream di WoW Forever e WoW Classic in diretta su Twitch, aggiornati più volte al giorno.',
  ...
  de: {
    ...
    'clips.metaTitle': 'WoW Forever Clips: die meistgesehenen des Tages',
    ...
    'streams.title': 'Streams',
    'streams.metaTitle': 'WoW Forever Streams, jetzt live auf Twitch',
    'streams.description': 'Live-Streams zu WoW Forever und WoW Classic auf Twitch, mehrmals am Tag aktualisiert.',
