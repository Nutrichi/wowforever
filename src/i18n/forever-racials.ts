 ...
 * tijdens de beta nog veranderen. Namen van racials blijven Engels.
 */
...
export const foreverRacials: Record<string, RaceRacials> = {
  ...
  gnome: {
    racials: [
      { name: 'Eureka!', state: 'new', text: w('Your next 3 spells or abilities cost less and deal or heal 10% more.', 'Je volgende 3 spells of abilities kosten minder en doen of helen 10% meer.', 'Vos 3 prochains sorts ou techniques coûtent moins et infligent ou soignent 10 % de plus.', 'Tus 3 próximos hechizos o habilidades cuestan menos e infligen o sanan un 10 % más.', 'I tuoi prossimi 3 incantesimi o abilità costano meno e infliggono o curano il 10% in più.', 'Deine nächsten 3 Zauber oder Fähigkeiten kosten weniger und verursachen oder heilen 10 % mehr.') },
  ...
  undead: {
    racials: [
      ...
      { name: 'Touch of the Grave', state: 'new', text: w('5% chance on hit to drain Health, up to 5% of your maximum Health.', '5% kans bij een treffer om Health af te tappen, tot 5% van je maximale Health.', '5 % de chances en touchant de drainer de la vie, jusqu’à 5 % de votre vie maximale.', '5 % de probabilidad al golpear de drenar salud, hasta un 5 % de tu salud máxima.', '5% di probabilità a colpo di drenare salute, fino al 5% della tua salute massima.', '5 % Chance bei Treffern, Gesundheit zu entziehen, bis zu 5 % deiner maximalen Gesundheit.') },
    ],
  ...
  tauren: {
    racials: [
      ...
      { name: 'Cultivation', state: 'changed', text: w('Grows bonus herbs that anyone can gather without Herbalism (was +15 Herbalism).', 'Laat extra kruiden groeien die iedereen kan plukken zonder Herbalism (was +15 Herbalism).', 'Fait pousser des herbes en plus que tout le monde peut cueillir sans Herbalism (avant : +15 en Herbalism).', 'Hace crecer hierbas extra que cualquiera puede recoger sin Herbalism (antes +15 de Herbalism).', 'Fa crescere erbe in più che chiunque può raccogliere senza Herbalism (prima +15 Herbalism).', 'Lässt zusätzliche Kräuter wachsen, die jeder ohne Herbalism sammeln kann (vorher +15 Herbalism).') },
